...
(begin (define x 5) (- 7 x) (* 4 x))
; expect 20

(begin (define y 4) (define y 5) (define y 9))
; expect y

(begin (+ 5 6) (- y 9))
; expect 0

(begin (define x (+ y x)) (* x 2))
; expect 28

(lambda (x y z) (+ x y) (- z 9))
; expect (lambda (x y z) (+ x y) (- z 9))

(define (bahgat x y z) (* x 4) (+ x y) (- z y) (+ 3 2))
; expect bahgat

bahgat
; expect (lambda (x y z) (* x 4) (+ x y) (- z y) (+ 3 2))

(define (ahmed f g h) (+ 4 f) (* g h) (- 3 4))
; expect ahmed

ahmed
; expect (lambda (f g h) (+ 4 f) (* g h) (- 3 4))


(define (f x) (- x (+ 2 3) (* 4 3)))
; expect f
...
(define g (lambda () (define x (+ 2 4)) (define y (- 3 4)) (f)))
; expect g
